...
const beveledBorderPx = 2 * 2 // border-3 * 2
...
const measureCommaFormattedWidth =
  (options: Partial<MeasureOptions> = {}) =>
  (n: bigint): number => {
...
export const isCommaFormattedOverflow =
  (options: Partial<MeasureOptions>) =>
  (value: bigint, availableWidthPx: number): boolean =>
    measureCommaFormattedWidth(options)(value) >= availableWidthPx
