 ...
 */
export interface StyledPropsWithChildren extends PropsWithChildren<StyledProps> {}
...
/**
 * A component that can be focused. When `isFocusable` is false, the component
 * will not grab or display focus.
 */
