...
export type WithPayload<Payload, Id extends string> = ActionCreatorWithPayload<
  Payload,
  Id
>

export interface DecIncPayload {
  isRepeating: boolean
}
...
export type DecIncActions = {
  [Name in DecIncKey]: WithPayload<DecIncPayload, `core/${Name}`>
}
