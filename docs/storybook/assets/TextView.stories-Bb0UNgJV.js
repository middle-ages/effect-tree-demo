import{j as t}from"./jsx-runtime-QFOfF_tH.js";import{k as v,A as N,t as m,l as p,f as y,s as b,i as u,n as _}from"./index-DIeet80g.js";import"./iframe-CvpaWoqK.js";import"./preload-helper-PPVm8Dsz.js";const a=e=>s=>v(w(e,s))(N),w=(e,s)=>({attributes:{className:i,style:o,...g}={},className:x,style:h,...f})=>({...f,as:e,attributes:{...g,style:{...o,...h},className:m(s,i,x)}});a.div=a("div");a.button=a("button");try{a.displayName="withClassName",a.__docgenInfo={description:`Given a tag name and a base class name, returns a component with a single
...
`,V=[7,6,5,4,3],P={component:l,parameters:{...b(S),...y},args:{lines:p(u(V),"lowerAscii","thin"),stats:{maxDegree:{id:"maxDegree",label:"max degree",title:"title foo",value:12n},maxDepth:{id:"maxDepth",label:"max depth",title:"title Bar",value:45n}}},render:function(s){return t.jsx("div",{className:"m-2 scroll-container overflow-hidden cq-4",children:t.jsx(l,{...s})})}},r={},n={args:{className:"*:text-[10px]",lines:p(u(_(1,100).map(e=>Math.floor(e**(9/10)))),"lower","unixRound")}};r.parameters={...r.parameters,docs:{...r.parameters?.docs,source:{originalSource:"{}",...r.parameters?.docs?.source}}};n.parameters={...n.parameters,docs:{...n.parameters?.docs,source:{originalSource:`{
  args: {
    className: '*:text-[10px]',
