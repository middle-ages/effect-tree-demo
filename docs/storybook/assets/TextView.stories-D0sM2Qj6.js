import{j as e}from"./jsx-runtime-HuQK5u_o.js";import{v as h,C as b,t as m,D as p,f as N,s as _,k as u,o as y}from"./index-BE5-cIaP.js";import"./iframe-BEe5FAEq.js";import"./preload-helper-PPVm8Dsz.js";const a=t=>s=>h(w(t,s))(b),w=(t,s)=>({attributes:{className:n,style:o,...g}={},className:x,style:v,...f})=>({...f,as:t,attributes:{...g,style:{...o,...v},className:m(s,n,x)}});a.div=a("div");a.button=a("button");try{a.displayName="withClassName",a.__docgenInfo={description:`Given a tag name and a base class name, returns a component with a single
