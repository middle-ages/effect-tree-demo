import{j as t}from"./jsx-runtime-EAAf7b9g.js";import{k as v,A as N,t as m,l as p,f as y,s as b,i as u,n as _}from"./index-d02C2rMV.js";import"./iframe-DcXzJmtC.js";import"./preload-helper-PPVm8Dsz.js";const a=e=>s=>v(w(e,s))(N),w=(e,s)=>({attributes:{className:i,style:o,...g}={},className:x,style:h,...f})=>({...f,as:e,attributes:{...g,style:{...o,...h},className:m(s,i,x)}});a.div=a("div");a.button=a("button");try{a.displayName="withClassName",a.__docgenInfo={description:`Given a tag name and a base class name, returns a component with a single
